...
public class AuthService {
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        return new AuthResponse(jwtService.generateToken(user), user.username(), user.role().name());
    }
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        return new AuthResponse(jwtService.generateToken(saved), saved.username(), saved.role().name());
    }
}