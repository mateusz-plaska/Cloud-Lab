...
@Slf4j
public record AutomatedPickFrozenZone(MessageBroker broker) implements Runnable {

    @Override
    public void run() {
        var containerPickedEvent = ContainerPickedEvent.from(PickType.AUTOMATED_FROZEN);
